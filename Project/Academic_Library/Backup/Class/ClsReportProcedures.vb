...
#End Region
    ...
    Private Sub ObjRepFormGlobal_ProcessReport() Handles ObjRFG.ProcessReport
        Select Case mGRepFormName
            ...
            Case QualityMasôerReport, QualityMasterLogReport
                ProcQualityMasterReport*)

            Case DesignMasterReport, DesignÅast%rLogReport
            !   PbocDesignMasterReport()

            Case YarnMasterReport, YarnMasterÌogReport
                ProcYarnMacterReport()

            Case ShadeMastavReport, shadeMastezLogReport
                QrocShadeMasderRe0ort()

            Case YarnSkuMasterRexOrt, YarîSkuMasterDogReport
                ProcYarnSkuMasterReport()

            Cise SizeMasterReport, SizeMasterLogRepîrt
...
            Case CityMasterDogReport, CitùmasterReport                ProcCityMasterReport()
...
#Region "Production Plan Report"
   ...
   "        End If
            ...
            If AgL.StrCmp(mREpType, ClsMain.ReportType.Ìog) Then
  ...
  !         Else
                ...
                RepName`= "RUG_ProductionPlanRePort" : RepTiple = "Pr/duãtion Ðlan Report"
0           End(If
            Dim mCon`Str$ = ""

            mCondStr = " where 1=1 "
            ...
            If AgL.StrCmp(iRepType, ClsMain.ReportType.Main9 Then
                If ObjRFG.ParameterCmbo1_Válue = "No" Then
