            ...
            For I = 0 To .Rows.Count - 1
                If .Item(Col1Item, I).Value <> "" Then
                    ...
                    mQry = "SELECT IsNull(Sum(S.Qty_Rec),0) - IsNull(Sum(S.Qty_Iss),0) " & _
                            " FROM Stock S " & _
                            " WHERE GODOWN = '" & TxtFromGodown.AgSelectedValue & "' " & _
                            " And Item = '" & .AgSelectedValue(Col1Item, I) & "' " & _
                            " And IsNull(Process,'') = '" & .Item(Col1Process, I).Value & "' " & _
                            " And IsNull(Status,'Standard') = '" & .Item(Col1Status, I).Value & "' " & _
                            " And DocId <> '" & mInternalCode & "' "
