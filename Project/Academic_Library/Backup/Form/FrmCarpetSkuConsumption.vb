Public Class FrmCarpetSkuConsumption
    ...
    Private Sub FrmDesignConsumption_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        TxtDescription.Text = TxtCarpetSKU.Text
    End Sub
    ...
    Private Sub FrmDesignConsumption_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = "Update BOM_Log Set CarpetSKU = " & AgL.Chk_Text(TxtCarpetSKU.AgSelectedValue) & " Where UID='" & SearchCode & "' "
...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.TxtCarpetSKU = New AgControls.AgTextBox
        ...
        'TxtCarpetSKU
        '
        Me.TxtCarpetSKU.AgMandatory = True
        Me.TxtCarpetSKU.AgMasterHelp = False
        Me.TxtCarpetSKU.AgNumberLeftPlaces = 0
        Me.TxtCarpetSKU.AgNumberNegetiveAllow = False
        Me.TxtCarpetSKU.AgNumberRightPlaces = 0
        Me.TxtCarpetSKU.AgPickFromLastValue = False
        Me.TxtCarpetSKU.AgRowFilter = ""
        Me.TxtCarpetSKU.AgSearchMethod = AgControls.AgLib.TxtSearchMethod.Simple
        Me.TxtCarpetSKU.AgSelectedValue = Nothing
        Me.TxtCarpetSKU.AgTxtCase = AgControls.AgTextBox.TxtCase.None
        Me.TxtCarpetSKU.AgValueType = AgControls.AgTextBox.TxtValueType.Text_Value
        Me.TxtCarpetSKU.BorderStyle = System.Windows.Forms.BorderStyle.None
        Me.TxtCarpetSKU.Font = New System.Drawing.Font("Arial", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.TxtCarpetSKU.Location = New System.Drawing.Point(370, 101)
        Me.TxtCarpetSKU.MaxLength = 0
        Me.TxtCarpetSKU.Multiline = True
        Me.TxtCarpetSKU.Name = "TxtCarpetSKU"
        Me.TxtCarpetSKU.Size = New System.Drawing.Size(255, 19)
        Me.TxtCarpetSKU.TabIndex = 792
        '
        'LblBuyerCity
        '
        ...
        Me.LblBuyerCity.Size = New System.Drawing.Size(77, 16)
        Me.LblBuyerCity.TabIndex = 793
        Me.LblBuyerCity.Text = "Carpet SKU"
        '
        'FrmCarpetSkuConsumption
        '
        Me.AutoScaleDimensions = New System.Drawing.SizeF(6.0!, 13.0!)
        Me.ClientSize = New System.Drawing.Size(857, 469)
        Me.Controls.Add(Me.Label13)
        Me.Controls.Add(Me.TxtCarpetSKU)
        ...
        Me.Name = "FrmCarpetSkuConsumption"
        Me.Text = "Carpet SKU Consumption Master"
        ...
        Me.Controls.SetChildIndex(Me.TxtCarpetSKU, 0)
...
#End Region
    ...
    Private Sub FrmDesignConsumption_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        With DsTemp.Tables(0)
            If DsTemp.Tables(0).Rows.Count > 0 Then
                TxtCarpetSKU.AgSelectedValue = AgL.XNull(.Rows(0)("CarpetSKU"))
            End If
        End With
    ...
    Private Sub FrmDesignConsumption_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        mQry = "SELECT S.Code, I.Description AS [Carpet SKU], D.ManualCode AS [Design Code], Size.Description as [Size], D.PileWeight, I.Div_Code, I.Status, IsNull(I.IsDeleted,0) as IsDeleted   " & _
               " FROM RUG_CarpetSku S " & _
               " LEFT JOIN item I ON S.Code = I.Code  " & _
               " LEFT JOIN RUG_Design D ON S.Design = D.Code  " & _
               " LEFT JOIN rug_size Size ON S.Size = Size.Code " & _
               " Order By I.Description "
        TxtCarpetSKU.AgHelpDataSet(2) = AgL.FillData(mQry, AgL.GCn)
    ...
    Private Sub TxtCarpetSKU_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtCarpetSKU.Enter
        Select Case sender.name
            Case TxtCarpetSKU.Name
                TxtCarpetSKU.AgRowFilter = " Status = '" & AgTemplate.ClsMain.EntryStatus.Active & "'  And  IsDeleted = 0 And " & ClsMain.RetDivFilterStr & ""
        End Select
    End Sub

    Private Sub TxtDesign_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TxtCarpetSKU.Validating
    ...
    Private Sub FrmCarpetSkuConsumption_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        mQry = "Select Code As SearchCode " & _
                " From BOM " & _
                " WHERE IsNull(IsDeleted,0)=0 And CarpetSku Is Not Null " & _
    ...
    Private Sub FrmCarpetSkuConsumption_BaseFunction_FIniMastLog(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMastLog
