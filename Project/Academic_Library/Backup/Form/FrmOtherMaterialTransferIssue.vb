Public Class FrmOtherMaterialTransferIssue
    ...
    Public Sub New(ByVal StrUPVar As String, ByVal DTUP As DataTable)
        ...
        Me.EntryNCat = ClsMain.Temp_NCat.OtherMaterialTransferIssue
    End Sub
...
#End Region
    ...
    Private Sub FrmOtherMaterialTransferIssue_BaseEvent_Topctrl_tbAdd() Handles Me.BaseEvent_Topctrl_tbAdd
        TxtFromGodown.AgSelectedValue = RetDefaultGodown(AgL.PubSiteCode, AgL.PubDivCode, ClsMain.ItemType.OtherMaterial)
    End Sub
