...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.TxtFromGodown.Location = New System.Drawing.Point(256, 79)
        ...
        Me.LblFromGodown.Location = New System.Drawing.Point(144, 81)
        ...
        Me.LblFromGodownReq.Location = New System.Drawing.Point(238, 86)
        ...
        Me.LblToGodownReq.Location = New System.Drawing.Point(238, 67)
        ...
        Me.TxtToGodown.Location = New System.Drawing.Point(256, 59)
        ...
        Me.LblToGodown.Location = New System.Drawing.Point(144, 61)
        ...
        Me.LblIssueNoReq.Location = New System.Drawing.Point(238, 107)
        ...
        Me.TxtIssueNo.Location = New System.Drawing.Point(256, 99)
        Me.TxtIssueNo.MaxLength = 20
        Me.TxtIssueNo.Name = "TxtIssueNo"
        Me.TxtIssueNo.Size = New System.Drawing.Size(445, 18)
        ...
        Me.LblIssueNo.Location = New System.Drawing.Point(144, 101)
...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1Status, 70, 0, Col1Status, True, True, False)
            .AddAgNumberColumn(Dgl1, Col1Qty, 100, 8, 3, False, Col1Qty, True, True, True)
            ...
            .AddAgNumberColumn(Dgl1, Col1DocQty, 90, 8, 3, False, Col1DocQty, True, False, False)
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                ...
                mQry = "INSERT INTO Stock_Log (UID, DocId, Sr, V_Type, V_Prefix, " & _
                        ...
                        " Item, Process, Godown, Qty_Rec, Unit, " & _
                        " MeasurePerPcs, Measure_Rec, MeasureUnit, Status, ReferenceDocId, Doc_Qty, Rate, Amount, Cost) " & _
                        ...
                        " " & AgL.Chk_Text(TxtToGodown.AgSelectedValue) & ", " & _
                        ...
                        " " & AgL.Chk_Text(Dgl1.Item(Col1Status, I).Value) & ", " & AgL.Chk_Text(TxtIssueNo.AgSelectedValue) & ", " & _
                        " " & Val(Dgl1.Item(Col1DocQty, I).Value) & ", " & Val(Dgl1.Item(Col1Rate, I).Value) & ", " & _
                ...
                mQry = "INSERT INTO StockProcess_Log (UID, DocId, Sr, V_Type, V_Prefix, " & _
                        ...
                        " MeasurePerPcs, Measure_Iss, " & _
                        " MeasureUnit, Status, ReferenceDocId, Doc_Qty, Rate, Amount, Cost) " & _
                        " VALUES (" & AgL.Chk_Text(mSearchCode) & ", " & AgL.Chk_Text(mInternalCode) & ", " & _
                        " " & mSr & ", " & AgL.Chk_Text(TxtV_Type.AgSelectedValue) & ", " & AgL.Chk_Text(LblPrefix.Text) & ", " & _
                        " " & AgL.Chk_Text(TxtV_Date.Text) & ", " & Val(TxtV_No.Text) & ", " & _
                        " " & AgL.Chk_Text(TxtDivision.AgSelectedValue) & ", " & AgL.Chk_Text(TxtSite_Code.AgSelectedValue) & ",  " & _
    ...
    Private Sub Txt_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TxtV_Type.Validating, TxtFromGodown.Validating, TxtToGodown.Validating, TxtIssueNo.Validating
    ...
    Private Sub FrmProductionOrder_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        ...
        TxtFromGodown.AgHelpDataSet(3, TabControl1.Top + TP1.Top, TabControl1.Left + TP1.Left) = AgL.FillData(mQry, AgL.GCn)
        TxtToGodown.AgHelpDataSet(3, TabControl1.Top + TP1.Top, TabControl1.Left + TP1.Left) = TxtFromGodown.AgHelpDataSet(3).Copy
        ...
        Dgl1.AgHelpDataSet(Col1Status) = AgL.FillData(AgTemplate_Common.ClsMain.HelpQueries.StockStatus, AgL.GCn)
        ...
        mQry = "SELECT S.DocID AS Code, Vt.Description + '/' + convert(NVARCHAR,S.V_No)  AS IssueNo, " & _
                ...
                " WHERE Vt.NCat = '" & AgTemplate_Common.ClsMain.Temp_NCat.StockTransferIssue & "' "
        ...
        With Dgl1
            For I = 0 To .Rows.Count - 1
                If .Item(Col1Item, I).Value <> "" Then
                    ...
                    If Val(.Item(Col1DocQty, I).Value) > Val(.Item(Col1Qty, I).Value) Then
                        MsgBox("Doc Qty Is Greater Than Qty At Row No " & Dgl1.Item(ColSNo, I).Value & "")
                        .CurrentCell = .Item(Col1DocQty, I) : Dgl1.Focus()
                        passed = False : Exit Sub
                    End If
                End If
    ...
    Protected Sub ProcFill(ByVal bIssueDocId As String)
        ...
        Try
            mQry = "SELECT S.Item, S.Process, S.Status, S.Qty_Rec, S.Unit, " & _
                    " S.MeasurePerPcs,S.Measure_Rec, S.MeasureUnit " & _
    ...
    Private Function Validate_IssueNo() As Boolean
        ...
        Try
            ...
            If TxtIssueNo.Text <> "" Then
                ...
                mQry = "SELECT Count(Sh.DocID)  " & _
                        " FROM StockHead_Log Sh " & _
                        " LEFT JOIN Voucher_Type Vt On Sh.V_Type = Vt.V_Type " & _
                        " WHERE Sh.ReferenceDocId = '" & TxtIssueNo.AgSelectedValue & "' " & _
                        " AND Sh.EntryStatus = '" & ClsMain.LogStatus.LogOpen & "' " & _
                        " AND " & IIf(AgL.StrCmp(Topctrl1.Mode, "Edit"), "Sh.DocId <> '" & mInternalCode & "'", "1=1") & " " & _
