Public Class FrmCarpetTransferReceive
    ...
    Public Sub New(ByVal StrUPVar As String, ByVal DTUP As DataTable)
        ...
        Me.EntryNCat = AgTemplate_Common.ClsMain.Temp_NCat.StockTransferReceive
    End Sub
...
#End Region
    ...
    Private Sub FrmOtherMaterialTransferIssue_BaseEvent_Topctrl_tbAdd() Handles Me.BaseEvent_Topctrl_tbAdd
        TxtToGodown.AgSelectedValue = RetDefaultGodown(AgL.PubSiteCode, AgL.PubDivCode, ClsMain.ItemType.CarpetSKU)
    End Sub
