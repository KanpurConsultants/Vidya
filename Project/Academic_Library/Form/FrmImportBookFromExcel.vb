Public Class FrmImportBookFromExcel
    ...
    Public _ObjStructColumn As New StructColumn()
    ...
    Public Structure StructColumn
        Public StrBookName As String
        Public StrSubject As String
        Public StrBookType As String
        Public StrWriter As String
        Public StrPublisher As String
    ...
    Public Property ObjStructColumn() As StructColumn
        Get
            ObjStructColumn = _ObjStructColumn
        End Get
        Set(ByVal value As StructColumn)
            _ObjStructColumn = value
        End Set
    End Property
        ...
        Try
            Select Case sender.name
                Case BtnOK.Name
                    ...
                    mQry += " [" & ObjStructColumn.StrBookName & "], "
                    mQry += " [" & ObjStructColumn.StrSubject & "], "
                    mQry += " [" & ObjStructColumn.StrBookType & "], "
                    mQry += " [" & ObjStructColumn.StrWriter & "], "
                    mQry += " [" & ObjStructColumn.StrPublisher & "], "
                    mQry += " [" & ObjStructColumn.StrVolume & "], "
                    mQry += " [" & ObjStructColumn.StrSeries & "], "
                    mQry += " [" & ObjStructColumn.StrISBN & "], "
                    mQry += " [" & ObjStructColumn.StrLanguage & "] "

                    mQry += " From [sheet1$] "
                    mQry += " Where [" & ObjStructColumn.StrBookName & "] Is Not Null "
