Public Class FrmNewBook
    ...
    Public Sub Ini_List()
        ...
        TxtBook.AgHelpDataSet(31) = AgL.FillData(mQry, AgL.GCn)
    ...
    Private Sub ProcSaveBook(ByVal Conn As SqlClient.SqlConnection, ByVal Cmd As SqlClient.SqlCommand)
        Try
            If TxtBook.Text <> "" And TxtBook.AgSelectedValue = "" Then
                ...
                mQry = " INSERT INTO Lib_Book_Log(UID, Code, Writer, Publisher,Subject,  Volume,	WithCD, BookType, BookDescription,PlaceOfPub,PubYear,pages) " & _
                ...
                mQry = " INSERT INTO Lib_Book(UID, Code, Writer, Publisher,Subject,  Volume,	WithCD, BookType, BookDescription,PlaceOfPub,PubYear,pages) " & _
                       " VALUES('" & mBookSearchCode & "','" & mBookInternalCode & "'," & AgL.Chk_Text(TxtWriter.Text) & ",	 " & _
                       " " & AgL.Chk_Text(TxtPublisher.Text) & ", " & _
                       "  " & AgL.Chk_Text(TxtSubject.AgSelectedValue) & ", " & _
                       " " & AgL.Chk_Text(TxtVolume.Text) & ", " & IIf(TXtWithCD.Text = "Yes", 1, 0) & ", " & _
                ...
                End If
            Else
                mQry = " Update Lib_Book_Log set Writer=" & AgL.Chk_Text(TxtWriter.Text) & ", Publisher=" & AgL.Chk_Text(TxtPublisher.Text) & " where code=" & AgL.Chk_Text(TxtBook.AgSelectedValue) & "  "
                AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)

                mQry = " Update Lib_Book set Writer=" & AgL.Chk_Text(TxtWriter.Text) & ", Publisher=" & AgL.Chk_Text(TxtPublisher.Text) & " where code=" & AgL.Chk_Text(TxtBook.AgSelectedValue) & "  "
                AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
            End If
