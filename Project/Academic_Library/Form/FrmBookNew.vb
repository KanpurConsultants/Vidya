Public Class FrmBookNew
    ...
    Friend WithEvents LblBokkNameReq As System.Windows.Forms.Label
...
#Region "Designer Code"
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmBookNew))
        ...
        Me.LblBokkNameReq = New System.Windows.Forms.Label
        ...
        'LblDescription
        '
        Me.LblDescription.Location = New System.Drawing.Point(176, 150)
        Me.LblDescription.Size = New System.Drawing.Size(102, 16)
        Me.LblDescription.Text = "Item Description"
        '
        'TxtDescription
        '
        Me.TxtDescription.Location = New System.Drawing.Point(302, 149)
        Me.TxtDescription.MaxLength = 100
        Me.TxtDescription.TabIndex = 5
        '
        'Label1
        '
        Me.Label1.Location = New System.Drawing.Point(286, 154)
        '
        'TxtUnit
        '
        ...
        Me.TxtBookName.Location = New System.Drawing.Point(302, 109)
        Me.TxtBookName.MaxLength = 100
        Me.TxtBookName.Name = "TxtBookName"
        Me.TxtBookName.Size = New System.Drawing.Size(385, 18)
        ...
        Me.LblBookName.Location = New System.Drawing.Point(176, 110)
        ...
        'LblBokkNameReq
        '
        Me.LblBokkNameReq.AutoSize = True
        Me.LblBokkNameReq.Font = New System.Drawing.Font("Wingdings 2", 5.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(2, Byte))
        Me.LblBokkNameReq.ForeColor = System.Drawing.Color.FromArgb(CType(CType(227, Byte), Integer), CType(CType(0, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.LblBokkNameReq.Location = New System.Drawing.Point(286, 116)
        Me.LblBokkNameReq.Name = "LblBokkNameReq"
        Me.LblBokkNameReq.Size = New System.Drawing.Size(10, 7)
        Me.LblBokkNameReq.TabIndex = 901
        Me.LblBokkNameReq.Text = "Ä"
        '
        'GBoxImportFromExcel
        '
        ...
        Me.Controls.Add(Me.LblBokkNameReq)
        ...
        Me.Controls.SetChildIndex(Me.LblBokkNameReq, 0)
...
#End Region
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = "UPDATE Item_Log " & _
                ...
                " DisplayName = " & AgL.Chk_Text(TxtBookName.Text) & " , " & _
        ...
        If Topctrl1.Mode = "Add" Then
            mQry = " INSERT INTO Lib_Book_Log(	Code,	Writer,	Publisher,	Series,	Subject,	Volume,	Language, ScrapCategory," & _
                    ...
                    " " & Val(LblManualCode.Tag) & " ," & AgL.Chk_Text(LblSubject.Tag) & "," & AgL.Chk_Text(LblBookType.Tag) & "," & AgL.Chk_Text(TxtBookName.Text) & ")"
            AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)
        Else
            mQry = " UPDATE Lib_Book_Log " & _
                     ...
                     " BookDescription = " & AgL.Chk_Text(TxtBookName.Text) & ", " & _
    ...
    Private Sub FrmOtherMaterial_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                TxtBookName.Text = AgL.XNull(.Rows(0)("BookDescription"))
    ...
    Private Sub FrmBook_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        ...
        mQry = " SELECT BT.Code,BT.Description AS [Book Type],BT.Suffix, " & _
           ...
           " FROM Lib_BookType BT " & _
           " Where " & AgL.PubSiteCondition("BT.Site_Code", AgL.PubSiteCode) & " "
        TxtBookType.AgHelpDataSet(4) = AgL.FillData(mQry, AgL.GCn)

        mQry = " SELECT BT.Code,BT.Description AS [Book Type], " & _
               " isnull(BT.IsDeleted,0) AS IsDeleted,ISNULL(Status,'" & AgTemplate.ClsMain.EntryStatus.Active & "') AS Status,BT.Div_Code " & _
               " FROM Lib_ScrapCategory BT " & _
               " Where " & AgL.PubSiteCondition("BT.Site_Code", AgL.PubSiteCode) & " "
        ...
        Try
            ...
            Select Case sender.name
                ...
                Case TxtBookName.Name, TxtVolume.Name
                    TxtDescription.Text = TxtBookName.Text.ToString & Space(1) & TxtVolume.Text.ToString
            End Select
    ...
    Private Sub FrmBookNew_BaseEvent_ApproveDeletion_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_ApproveDeletion_InTrans
        If TxtWithCD.Text = "Yes" Then
            Call ProcSaveCDItem(True, Conn, Cmd)
        Else
            Call ProcSaveCDItem(False, Conn, Cmd)
    ...
    Private Sub BtnImprtFromExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnImprtFromExcel.Click
        ...
        DtTemp = AgL.FillData(mQry, AgL.GCn).Tables(0)
        Dim ObjFrmImport As New FrmImportBookFromExcel
        ObjFrmImport.LblTitle.Text = "Subject Import"

        Dim ObjStructBook As New FrmImportBookFromExcel.StructColumn()
        With ObjStructBook
            .ProcBlankStruct()
            .StrBookName = "Book Name"
            .StrSubject = "Subject"
            .StrBookType = "Book Type"
            .StrWriter = "Writer"
        ...
        ObjFrmImport.ObjStructColumn = ObjStructBook
        ...
        For I = 0 To DtTemp.Rows.Count - 1
            ...
            TxtBookName.Text = AgL.XNull(DtTemp.Rows(I)("Book Name"))
            TxtWriter.Text = AgL.XNull(DtTemp.Rows(I)("Writer"))
            TxtPublisher.Text = AgL.XNull(DtTemp.Rows(I)("Publisher"))
            TxtVolume.Text = AgL.XNull(DtTemp.Rows(I)("Volume"))
            TxtSeries.Text = AgL.XNull(DtTemp.Rows(I)("Series"))
            TxtISBN.Text = AgL.XNull(DtTemp.Rows(I)("ISBN"))
            TxtLanguage.Text = AgL.XNull(DtTemp.Rows(I)("Language"))

            If AgL.XNull(DtTemp.Rows(I)("Subject")).ToString.Trim <> "" Then
                DrTemp = TxtSubject.AgHelpDataSet.Tables(0).Select("Subject = " & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("Subject"))) & "")
                If DrTemp.Length > 0 Then
                    TxtSubject.AgSelectedValue = AgL.XNull(DrTemp(0)("Code"))
                End If
                DrTemp = Nothing
            End If

            If AgL.XNull(DtTemp.Rows(I)("Book Type")).ToString.Trim <> "" Then
                DrTemp = TxtBookType.AgHelpDataSet.Tables(0).Select("[Book Type] = " & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("Book Type"))) & "")
                If DrTemp.Length > 0 Then
                    TxtBookType.AgSelectedValue = AgL.XNull(DrTemp(0)("Code"))
                End If
                DrTemp = Nothing
            End If

            TxtDescription.Text = TxtBookName.Text.ToString
            If TxtVolume.Text.ToString.Trim <> "" Then TxtDescription.Text += Space(1) & TxtVolume.Text.ToString
            If TxtBookType.Text.ToString.Trim <> "" Then TxtDescription.Text += "-{" & TxtBookType.Text.ToString & "}"
