...
Public Class FrmVehicleGateInOut
    ...
    Sub Ini_List()
        Try
            mQry = "Select V_Type as Code, Description, NCat From Voucher_Type Where NCat = '" & ClsMain.Temp_NCat.VehicleGate & "' "
            ...
            mQry = "Select E.Subcode As Code, Sg.Name, Sg.ManualCode, Sg.DispName, " & _
            ...
            mQry = "Select H.RegistrationNo  As Code, H.RegistrationNo As [Vehicle No], " & _
                    " H.Description As [Vehicle Name], H.VehicleType [Vehicle Type], " & _
                    " H.MeterReading, H.Code As VehicleCode " & _
                    " From Tp_Vehicle H " & _
                    " UNION ALL " & _
                    " SELECT DISTINCT H.VehicleNo AS Code, H.VehicleNo As [Vehicle No], " & _
                    " H.VehicleNo As [Vehicle Name], H.VehicleType [Vehicle Type], " & _
                    " 0 As MeterReading, '' As VehicleCode " & _
                    " FROM GateInOut H " & _
                    " Left Join Tp_Vehicle V On H.VehicleNo = V.RegistrationNo " & _
                    " WHERE V.Code Is Null And isnull(H.VehicleNo,'') != '' " & _
                    " Order By [Vehicle No] "
            TxtVehicleNo.AgHelpDataSet(1) = AgL.FillData(mQry, AgL.GCn)

            mQry = " SELECT DISTINCT H.VehicleType AS Code, H.VehicleType  " & _
                    " FROM GateInOut H " & _
                    " WHERE isnull(H.VehicleType,'') != ''  "
            TxtVehicleType.AgHelpDataSet(0) = AgL.FillData(mQry, AgL.GCn)
            ...
            mQry = "SELECT H.DocID AS Code, H.Manual_RefNo AS [Open No], " & _
                    " H.VehicleNo AS [Vehicle No], H.VehicleType, Sg.DispName AS [Driver Name], " & _
    ...
    Private Sub Topctrl1_tbAdd() Handles Topctrl1.tbAdd
        ...
        TxtInOut.Text = ClsMain.InOut.GateOut : mBlnIsCloseRecord = False
        ...
        If mTmV_Type.Trim = "" Then
            If TxtV_Type.Enabled = True Then TxtV_Type.Focus() Else TxtVehicleNo.Focus()
        Else
            TxtVehicleNo.Focus()
        End If
    End Sub
    ...
    Private Sub Topctrl1_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            ...
            AgL.PubFindQry = " SELECT H.DocID  + '1' AS SearchCode, " & _
                                ...
                                " H.V_Date AS EntryDate, H.V_Time AS EntryTime, H.VehicleNo AS [Vehicle No], H.VehicleType [Vehicle Type], " & _
                                " H.Driver, H.MeterReading AS [Meter Reading], H.Remarks AS [Remark], " & _
                                ...
                                " H.Close_Date AS EntryDate, H.Close_Time AS EntryTime, H.VehicleNo AS [Vehicle No], H.VehicleType [Vehicle Type],  " & _
                                " H.Driver, H.Close_MeterReading AS [Meter Reading],  " & _
        ...
        Try
            ...
            If mSearchCode.Trim <> "" Then
                ...
                With DsTemp.Tables(0)
                    ...
                    TxtVehicleNo.Tag = AgL.XNull(.Rows(0)("VehicleNo"))
                    DrTemp = TxtVehicleNo.AgHelpDataSet.Tables(0).Select("Code = " & AgL.Chk_Text(AgL.XNull(.Rows(0)("VehicleNo"))) & "")
                    ...
                    TxtOpenMeterReading.Text = Format(AgL.VNull(.Rows(0)("MeterReading")), "0.00")
                    ...
                    If mBlnIsCloseRecord Then
                        ...
                        TxtOpenManualNo.AgSelectedValue = mSearchCode
    ...
    Private Sub DispText(Optional ByVal Enb As Boolean = False)
        ...
        TxtVehicleType.Enabled = False : TxtVehicleName.Enabled = False
    ...
    Private Sub Control_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles _
        ...
        TxtVehicleType.Validating, TxtRemarks.Validating, TxtInOut.Validating, TxtOpenManualNo.Validating
        Dim DrTemp As DataRow() = Nothing
    ...
    Private Sub Control_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles _
        ...
        TxtVehicleType.Enter, TxtRemarks.Enter
            ...
            Case TxtVehicleNo.Name
                ...
                Else
                    If Sender.AgHelpDataSet IsNot Nothing Then
                        ...
                        TxtVehicleType.Text = AgL.XNull(DrTemp(0)("Vehicle Type"))
                    End If
                End If
                DrTemp = Nothing

                If TxtOpenManualNo.AgHelpDataSet.Tables(0).Rows.Count > 0 Then
                    DrTemp = TxtOpenManualNo.AgHelpDataSet.Tables(0).Select("[Vehicle No] = " & AgL.Chk_Text(TxtVehicleNo.Text) & "")
                    If DrTemp.Length > 0 Then
                        ...
                        If Not bBlnIsClosed Then
                            ...
                            TxtParty.AgSelectedValue = AgL.XNull(DrTemp(0)("SubCode"))
                            TxtDriverName.Text = AgL.XNull(DrTemp(0)("Driver Name"))
