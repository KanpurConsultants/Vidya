        ...
        Try
            ...
            If DTMaster.Rows.Count > 0 Then
                If MsgBox("Are You Sure To Delete This Record?", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, AgLibrary.ClsMain.PubMsgTitleInfo) = vbYes Then
                    ...
                    AgL.Dman_ExecuteNonQry("Delete From Tp_Enviro Where Site_Code='" & mSearchCode & "'", AgL.GCn, AgL.ECmd)
    ...
    Private Sub Topctrl1_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            ...
            AgL.PubFindQry = " Select  E.Site_Code As SearchCode,  S.Name As [" & LblSite_Code.Text & "], " & _
                                " AG.GroupName AS [" & LblMemberACGroup.Text & "], " & _
                                " AgE.GroupName AS [" & LblEmployeeAcGroup.Text & "] " & _
                                " From Tp_Enviro E " & _
                                " Left Join SiteMast S On E.Site_Code = S.Code " & _
                                " LEFT JOIN AcGroup AG ON AG.GroupCode= E.MemberACGroup " & _
                                " LEFT JOIN AcGroup AgE ON Ag.GroupCode= E.EmployeeACGroup "
    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                mQry = " INSERT INTO Tp_Enviro	(Site_Code,	MemberACGroup, EmployeeAcGroup, " & _
