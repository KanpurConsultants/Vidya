...
Public Class FrmEMailEnviro
    ...
    Private Sub Topctrl1_tbEdit() Handles Topctrl1.tbEdit
        DispText(True)
        TcEnviro.SelectedTab = TpParameter
        TxtSmtpHost.Focus()
    End Sub
    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                mQry = "INSERT INTO EMail_Enviro ( Site_Code, SmtpHost, SmtpPort, " & _
                        " OutGoingMailId, OutGoingMailIdPassword, EnableSsl, " & _
                        " Div_Code, PreparedBy, U_EntDt, U_AE) " & _
                        " VALUES ( " & _
                        " " & AgL.Chk_Text(TxtSite_Code.AgSelectedValue) & ", " & AgL.Chk_Text(TxtSmtpHost.Text) & ", " & _
                        " " & Val(TxtSmtpPort.Text) & ", " & AgL.Chk_Text(TxtEmailAddress.Text) & ", " & _
                        " " & AgL.Chk_Text(TxtEmailPassword.Text) & ", " & IIf(AgL.StrCmp(TxtEnableSsl.Text, "Yes"), 1, 0) & ", " & _
                        " '" & AgL.PubDivCode & "', '" & AgL.PubUserName & "', " & AgL.ConvertDate(AgL.PubLoginDate) & ", 'A' )"

                AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)
            Else
                mQry = "Update EMail_Enviro " & _
                        " SET " & _
                        " SmtpHost = " & AgL.Chk_Text(TxtSmtpHost.Text) & ", " & _
                        " SmtpPort = " & Val(TxtSmtpPort.Text) & ", " & _
                        " OutGoingMailId =" & AgL.Chk_Text(TxtEmailAddress.Text) & ", " & _
                        " OutGoingMailIdPassword =" & AgL.Chk_Text(TxtEmailPassword.Text) & ", " & _
                        " EnableSsl = " & IIf(AgL.StrCmp(TxtEnableSsl.Text, "Yes"), 1, 0) & ", " & _
                        " U_AE = 'E', " & _
            ...
            If DTMaster.Rows.Count > 0 Then
                ...
                With DsTemp.Tables(0)
                    If .Rows.Count > 0 Then
                        ...
                        TxtSmtpHost.Text = AgL.XNull(.Rows(0)("SmtpHost"))
                        TxtSmtpPort.Text = AgL.VNull(.Rows(0)("SmtpPort"))
                        TxtEmailAddress.Text = AgL.XNull(.Rows(0)("OutGoingMailId"))
                        TxtEmailPassword.Text = AgL.XNull(.Rows(0)("OutGoingMailIdPassword"))
                        TxtEnableSsl.Text = IIf(AgL.VNull(.Rows(0)("EnableSsl")), "Yes", "No")
