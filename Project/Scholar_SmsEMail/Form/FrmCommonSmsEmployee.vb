...
Public Class FrmCommonSmsEmployee
    ...
    Protected Const Col1IsTeachingStaff As String = "Teaching Staff"
    ...
    Private Sub IniGrid()
        Try
            With AgCL
                ...
                .AddAgTextColumn(DGL1, Col1Name, 300, 0, Col1Name, True, True, False)
                ...
                .AddAgTextColumn(DGL1, Col1IsTeachingStaff, 80, 3, Col1IsTeachingStaff, True, True, False)
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            SmsCategory = ClsMain.SmsCategorty.CommonEmployee
    ...
    Sub Ini_List()
        Try
            ...
            mQry = " Select 'Yes' As Code, 'Yes' As Name " & _
                    " UNION ALL " & _
                    " Select 'No' As Code, 'No' As Name " & _
                    " UNION ALL " & _
                    " Select 'All' As Code, 'All' As Name "
            TxtIsTeachingStaff.AgHelpDataSet = AgL.FillData(mQry, AgL.GcnRead)
            TxtLeftEmployee.AgHelpDataSet = TxtIsTeachingStaff.AgHelpDataSet.Copy
    ...
    Private Sub Topctrl1_tbAdd() Handles Topctrl1.tbAdd
        ...
        TxtIsTeachingStaff.Text = "Yes" : TxtLeftEmployee.Text = "No"
                ...
                With DsTemp.Tables(0)
                    ...
                    If .Rows.Count > 0 Then
                        ...
                        For bIntI = 0 To DsTemp.Tables(0).Rows.Count - 1
                            ...
                            DGL1.AgSelectedValue(Col1Name, bIntI) = AgL.XNull(.Rows(bIntI)("SubCode"))

                            DrTemp = DGL1.AgHelpDataSet(Col1Name).Tables(0).Select("Code = " & AgL.Chk_Text(AgL.XNull(.Rows(bIntI)("SubCode"))) & " ")
                            If DrTemp.Length > 0 Then
                                DGL1.Item(Col1SubCode, bIntI).Value = AgL.XNull(DrTemp(0)("Code"))
                                DGL1.Item(Col1IsTeachingStaff, bIntI).Value = AgL.XNull(DrTemp(0)("Teaching Staff"))
    ...
    Private Sub Control_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _
            ...
            TxtLeftEmployee.Enter, TxtIsTeachingStaff.Enter, TxtSelectAll.Enter
    ...
    Private Sub Control_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles _
        ...
        TxtLeftEmployee.Validating, TxtIsTeachingStaff.Validating, TxtSelectAll.Validating
                ...
                Select Case .Columns(.CurrentCell.ColumnIndex).Name
                    Case Col1Name
                        If DGL1.Item(mColumnIndex, mRowIndex).Value.ToString.Trim = "" Or DGL1.AgSelectedValue(mColumnIndex, mRowIndex).Trim = "" Then
                            ...
                            DGL1.Item(Col1IsTeachingStaff, mRowIndex).Value = ""
                        ...
                        Else
                            If DGL1.AgHelpDataSet(mColumnIndex) IsNot Nothing Then
                                ...
                                DGL1.Item(Col1IsTeachingStaff, mRowIndex).Value = AgL.XNull(DrTemp(0)("Teaching Staff"))
    ...
    Private Sub ProcFillData()
        ...
        Try
            ...
            If AgL.StrCmp(TxtIsTeachingStaff.Text, "Yes") Then
                bCondStr += " And IsNull(E.IsTeachingStaff,0) <> 0 "

            ElseIf AgL.StrCmp(TxtIsTeachingStaff.Text, "No") Then
                bCondStr += " And IsNull(E.IsTeachingStaff,0) = 0 "
            End If

            If AgL.StrCmp(TxtLeftEmployee.Text, "Yes") Then
                bCondStr += " And DateOfResign Is Not Null "

            ElseIf AgL.StrCmp(TxtLeftEmployee.Text, "No") Then
                bCondStr += " And DateOfResign Is Null "
            End If

            mQry = "Select E.Subcode, Sg.Name, " & _
                    " Right(IsNull(Sg.Mobile,''),10) As Mobile, " & _
                    " Case When IsNull(E.IsTeachingStaff,0) <> 0 Then 'Yes' Else 'No' End As [Teaching Staff], " & _
                    " City.CityName As City, " & _
                    " Sg.ManualCode, " & _
            ...
            With DtTemp
                ...
                If .Rows.Count > 0 Then
                    For bIntI = 0 To DtTemp.Rows.Count - 1
                        ...
                        DGL1.Item(Col1Mobile, bIntI).Value = AgL.XNull(.Rows(bIntI)("Mobile"))
                        DGL1.Item(Col1IsTeachingStaff, bIntI).Value = AgL.XNull(.Rows(bIntI)("Teaching Staff"))
                    Next bIntI
                Else
