...
ByVal lpFileName As String) As Int32
    ...
    Private Sub FrmServerNotFound_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        TxtDatabasePassword.Text = AgL.PubDBPasswordSQL
        TxtDatabaseUser.Text = AgL.PubDBUserSQL
    End Sub

    Private Sub BtnOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnOk.Click
        Dim mErr As String
        mErr = ModMain.ConnectDb(TxtSqlServerName.Text, TxtDatabaseName.Text, TxtDatabaseUser.Text, TxtDatabasePassword.Text)
        If mErr <> "" Then
        ...
        Else
            If MsgBox("Database is successfully connected. Do you want to update information in configuration settings", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                ...
                WritePrivateProfileString("Security", "Password", AgL.CODIFY(TxtDatabasePassword.Text), mIniPath)
                WritePrivateProfileString("Security", "User", TxtDatabaseUser.Text, mIniPath)
            End If
            Me.Hide()
        End If
    End Sub
    ...
    Public Function CheckDatabaseErrors(ByVal Err As String)
        ...
        ElseIf Err.Length > 21 AndAlso Err.Substring(0, 21) = "Login failed for user" Then
            CheckDatabaseErrors = "Either database password or username is incorrect"
    ...
    Private Sub CreateDB()
        ...
        mErr = ModMain.ConnectDb(TxtSqlServerName.Text, "Master", AgL.PubDBUserSQL, TxtDatabasePassword.Text)
        If mErr = "" Then
            ...
            AgL.Dman_ExecuteNonQry(mScript, AgL.GCn)
            mErr = ModMain.ConnectDb(TxtSqlServerName.Text, TxtDatabaseName.Text, AgL.PubDBUserSQL, TxtDatabasePassword.Text)
            If mErr = "" Then
                WritePrivateProfileString("Server", "Name", TxtSqlServerName.Text, mIniPath)
