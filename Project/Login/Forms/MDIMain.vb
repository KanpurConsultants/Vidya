...
Public Class MDIMain
    ...
    Dim Cls_Scholar_SmsEMail As New Scholar_SmsEMail.ClsMain(AgL)

    Dim Cls_Scholar_Main As New Scholar_Main.ClsMain(AgL, PLib)
    Dim Cls_Scholar_TimeTable As New Scholar_TimeTable.ClsMain(AgL, PLib)
    Dim Cls_Academic_Exam As New Scholar_Exam.ClsMain(AgL, PLib)
    Dim Cls_Academic_Store As New Scholar_Store.ClsMain(AgL, PLib)
    Dim Cls_Scholar_Hostel As New Academic_Hostel.ClsMain(AgL, PLib)
    Dim Cls_Scholar_Common As New Scholar_Common.ClsMain(AgL, PLib)
    Dim Cls_Scholar_Fee As New Scholar_Fee.ClsMain(AgL, PLib)
    ...
    Dim Cls_Scholar_Enquiry As New Scholar_Enquiry.ClsMain(AgL, PLib)
    Dim Cls_Academic_Transport As New Academic_Transport.ClsMain(AgL)
    Dim Cls_Academic_Mess As New Academic_Mess.ClsMain(AgL)
    Dim Cls_Academic_Canteen As New Academic_Canteen.ClsMain(AgL)
    ...
    Public Sub FMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Trim(UCase(StrCurrentModule))
            ...
            Case Trim(UCase(Scholar_SmsEMail.ClsMain.ModuleName))
                If StrType.Trim = "" Then
                    FrmObj = Cls_Scholar_SmsEMail.CFOpen.FOpen(sender.NAME, sender.TEXT, True)
                ElseIf Not AgL.StrCmp(StrType.Trim, "CWDS") Then
                    FrmObj = Cls_Scholar_SmsEMail.CFOpen.FOpen(sender.NAME, sender.TEXT, False)
                End If
            ...
            Case Trim(UCase(Scholar_Fee.ClsMain.ModuleName))
                If StrType.Trim = "" Then
                    FrmObj = Cls_Scholar_Fee.CFOpen.FOpen(sender.NAME, sender.TEXT, True)
                ElseIf Not AgL.StrCmp(StrType.Trim, "CWDS") Then
                    FrmObj = Cls_Scholar_Fee.CFOpen.FOpen(sender.NAME, sender.TEXT, False)
                End If


            Case Trim(UCase(Scholar_Enquiry.ClsMain.ModuleName))
                If StrType.Trim = "" Then
                    FrmObj = Cls_Scholar_Enquiry.CFOpen.FOpen(sender.NAME, sender.TEXT, True)
                ElseIf Not AgL.StrCmp(StrType.Trim, "CWDS") Then
                    FrmObj = Cls_Scholar_Enquiry.CFOpen.FOpen(sender.NAME, sender.TEXT, False)
                End If

            Case Trim(UCase(Academic_Transport.ClsMain.ModuleName))
                If StrType.Trim = "" Then
                    FrmObj = Cls_Academic_Transport.CFOpen.FOpen(sender.NAME, sender.TEXT, True)
                ElseIf Not AgL.StrCmp(StrType.Trim, "CWDS") Then
                    FrmObj = Cls_Academic_Transport.CFOpen.FOpen(sender.NAME, sender.TEXT, False)
                End If

            Case Trim(UCase(Academic_Mess.ClsMain.ModuleName))
                If StrType.Trim = "" Then
                    FrmObj = Cls_Academic_Mess.CFOpen.FOpen(sender.NAME, sender.TEXT, True)
                ElseIf Not AgL.StrCmp(StrType.Trim, "CWDS") Then
                    FrmObj = Cls_Academic_Mess.CFOpen.FOpen(sender.NAME, sender.TEXT, False)
                End If

            Case Trim(UCase(Academic_Canteen.ClsMain.ModuleName))
                If StrType.Trim = "" Then
                    FrmObj = Cls_Academic_Canteen.CFOpen.FOpen(sender.NAME, sender.TEXT, True)
                ElseIf Not AgL.StrCmp(StrType.Trim, "CWDS") Then
                    FrmObj = Cls_Academic_Canteen.CFOpen.FOpen(sender.NAME, sender.TEXT, False)
                End If

            Case Trim(UCase(mScholar_Main))
                If StrType.Trim = "" Then
                    FrmObj = Cls_Scholar_Main.CFOpen.FOpen(sender.NAME, sender.TEXT, True)
                ElseIf Not AgL.StrCmp(StrType.Trim, "CWDS") Then
                    FrmObj = Cls_Scholar_Main.CFOpen.FOpen(sender.NAME, sender.TEXT, False)
                End If

            Case Trim(UCase(mScholar_TimeTable))
                If StrType.Trim = "" Then
                    FrmObj = Cls_Scholar_TimeTable.CFOpen.FOpen(sender.NAME, sender.TEXT, True)
                ElseIf Not AgL.StrCmp(StrType.Trim, "CWDS") Then
                    FrmObj = Cls_Scholar_TimeTable.CFOpen.FOpen(sender.NAME, sender.TEXT, False)
                End If

            Case Trim(UCase(mAcademic_Exam))
                If StrType.Trim = "" Then
                    FrmObj = Cls_Academic_Exam.CFOpen.FOpen(sender.NAME, sender.TEXT, True)
                ElseIf Not AgL.StrCmp(StrType.Trim, "CWDS") Then
                    FrmObj = Cls_Academic_Exam.CFOpen.FOpen(sender.NAME, sender.TEXT, False)
                End If

            Case Trim(UCase(mAcademic_Store))
                If StrType.Trim = "" Then
                    FrmObj = Cls_Academic_Store.CFOpen.FOpen(sender.NAME, sender.TEXT, True)
                ElseIf Not AgL.StrCmp(StrType.Trim, "CWDS") Then
                    FrmObj = Cls_Academic_Store.CFOpen.FOpen(sender.NAME, sender.TEXT, False)
                End If

            Case Trim(UCase(mScholar_Hostel))
                If StrType.Trim = "" Then
                    FrmObj = Cls_Scholar_Hostel.CFOpen.FOpen(sender.NAME, sender.TEXT, True)
                ElseIf Not AgL.StrCmp(StrType.Trim, "CWDS") Then
                    FrmObj = Cls_Scholar_Hostel.CFOpen.FOpen(sender.NAME, sender.TEXT, False)
                End If
    ...
    Private Sub FManageMDI()
        ...
        If Academic_ProjLib.ClsMain.IsModuleActive_Enquiry Then ClsMF.FGenerate_UP(New Scholar_Enquiry.MDIMain, Scholar_Enquiry.ClsMain.ModuleName, 0, Scholar_Enquiry.ClsMain.ModuleName, GCnCmd)
        If Academic_ProjLib.ClsMain.IsModuleActive_AcademicMain Then ClsMF.FGenerate_UP(New Scholar_Main.MDIMain, mScholar_Main, 0, mScholar_Main, GCnCmd)
        If Academic_ProjLib.ClsMain.IsModuleActive_FeeModule Then ClsMF.FGenerate_UP(New Scholar_Fee.MDIMain, Scholar_Fee.ClsMain.ModuleName, 0, Scholar_Fee.ClsMain.ModuleName, GCnCmd)

        If Academic_ProjLib.ClsMain.IsModuleActive_TimeTable Then ClsMF.FGenerate_UP(New Scholar_TimeTable.MDIMain, mScholar_TimeTable, 0, mScholar_TimeTable, GCnCmd)
        If Academic_ProjLib.ClsMain.IsModuleActive_Exam Then ClsMF.FGenerate_UP(New Scholar_Exam.MDIMain, mAcademic_Exam, 0, mAcademic_Exam, GCnCmd)
        If Academic_ProjLib.ClsMain.IsModuleActive_Store Then ClsMF.FGenerate_UP(New Scholar_Store.MDIMain, mAcademic_Store, 0, mAcademic_Store, GCnCmd)
        If Academic_ProjLib.ClsMain.IsModuleActive_Hostel Then ClsMF.FGenerate_UP(New Academic_Hostel.MDIMain, mScholar_Hostel, 0, mScholar_Hostel, GCnCmd)
        ...
        If Academic_ProjLib.ClsMain.IsModuleActive_Transport Then ClsMF.FGenerate_UP(New Academic_Transport.MDIMain, Academic_Transport.ClsMain.ModuleName, 0, Academic_Transport.ClsMain.ModuleName, GCnCmd)
        If Academic_ProjLib.ClsMain.IsModuleActive_Mess Then ClsMF.FGenerate_UP(New Academic_Mess.MDIMain, Academic_Mess.ClsMain.ModuleName, 0, Academic_Mess.ClsMain.ModuleName, GCnCmd)
        If Academic_ProjLib.ClsMain.IsModuleActive_Canteen Then ClsMF.FGenerate_UP(New Academic_Canteen.MDIMain, Academic_Canteen.ClsMain.ModuleName, 0, Academic_Canteen.ClsMain.ModuleName, GCnCmd)
        ...
        If AgLibrary.ClsConstant.IsSmsActive _
            ...
            ClsMF.FGenerate_UP(New Scholar_SmsEMail.MDIMain, Scholar_SmsEMail.ClsMain.ModuleName, 0, Scholar_SmsEMail.ClsMain.ModuleName, GCnCmd)
    ...
    Private Sub FManageUserControl()
        ...
        Try
            ...
            If AgLibrary.ClsConstant.IsSmsActive Or AgLibrary.ClsConstant.IsEMailActive Then
                ClsMF.FGenerate_UP_Control(Cls_EMail, Scholar_SmsEMail.ClsMain.ModuleName, GCnCmd)
            End If

            Call ClsMF.FGenerate_UP_Control(Cls_Scholar_Common, Scholar_Common.ClsMain.ModuleName, GCnCmd)
            If Academic_ProjLib.ClsMain.IsModuleActive_AcademicMain Then ClsMF.FGenerate_UP_Control(Cls_Scholar_Main, mScholar_Main, GCnCmd)
            If Academic_ProjLib.ClsMain.IsModuleActive_FeeModule Then ClsMF.FGenerate_UP_Control(Cls_Scholar_Fee, Scholar_Fee.ClsMain.ModuleName, GCnCmd)
            If Academic_ProjLib.ClsMain.IsModuleActive_TimeTable Then ClsMF.FGenerate_UP_Control(Cls_Scholar_TimeTable, mScholar_TimeTable, GCnCmd)
            If Academic_ProjLib.ClsMain.IsModuleActive_Exam Then ClsMF.FGenerate_UP_Control(Cls_Academic_Exam, mAcademic_Exam, GCnCmd)
            If Academic_ProjLib.ClsMain.IsModuleActive_Store Then ClsMF.FGenerate_UP_Control(Cls_Academic_Store, mAcademic_Store, GCnCmd)
            If Academic_ProjLib.ClsMain.IsModuleActive_Hostel Then ClsMF.FGenerate_UP_Control(Cls_Scholar_Hostel, mScholar_Hostel, GCnCmd)
            ...
            If Academic_ProjLib.ClsMain.IsModuleActive_Enquiry Then ClsMF.FGenerate_UP_Control(Cls_Scholar_Enquiry, Scholar_Enquiry.ClsMain.ModuleName, GCnCmd)
            If Academic_ProjLib.ClsMain.IsModuleActive_Transport Then ClsMF.FGenerate_UP_Control(Cls_Academic_Transport, Academic_Transport.ClsMain.ModuleName, GCnCmd)
            If Academic_ProjLib.ClsMain.IsModuleActive_Mess Then ClsMF.FGenerate_UP_Control(Cls_Academic_Mess, Academic_Mess.ClsMain.ModuleName, GCnCmd)
            If Academic_ProjLib.ClsMain.IsModuleActive_Canteen Then ClsMF.FGenerate_UP_Control(Cls_Academic_Canteen, Academic_Canteen.ClsMain.ModuleName, GCnCmd)
    ...
    Private Sub MDIMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Dim MDI_Fee As New Scholar_Fee.MDIMain
            Try
                StrUserPermission = AgIniVar.FunGetUserPermission(Scholar_Fee.ClsMain.ModuleName, MDI_Fee.MnuFmFeeReceiveEntry.Name, MDI_Fee.MnuFmFeeReceiveEntry.Text, DTUP)
                If Not AgL.StrCmp(StrUserPermission, "****") Then
                    FrmObj = New Scholar_Fee.FrmInstallmentReminder()
                    FrmObj.MdiParent = Me
                    FrmObj.Show()
                    FrmObj = Nothing

                    FrmObj = New Scholar_Fee.FrmAdvanceReminder()
                    FrmObj.MdiParent = Me
                    FrmObj.Show()
                    FrmObj = Nothing
                End If
            ...
            Try
                Dim MDI_Enquiry As New Scholar_Enquiry.MDIMain
                StrUserPermission = AgIniVar.FunGetUserPermission(Scholar_Enquiry.ClsMain.ModuleName, MDI_Enquiry.MnuEnquiryFollowup.Name, MDI_Enquiry.MnuEnquiryFollowup.Text, DTUP)
                If Not AgL.StrCmp(StrUserPermission, "****") Then
                    FrmObj = New Scholar_Enquiry.FrmFollowupReminder()
                    FrmObj.MdiParent = Me
                    FrmObj.Show()
                    FrmObj = Nothing
                End If
            ...
            Try
                Dim MDI_Transport As New Academic_Transport.MDIMain
                StrUserPermission = AgIniVar.FunGetUserPermission(Academic_Transport.ClsMain.ModuleName, MDI_Transport.MnuVehicleMaintenanceExpenseEntry.Name, MDI_Transport.MnuVehicleMaintenanceExpenseEntry.Text, DTUP)
                If Not AgL.StrCmp(StrUserPermission, "****") Then
                    FrmObj = New Academic_Transport.FrmMaintinanceReminder()
                    FrmObj.MdiParent = Me
                    FrmObj.Show()
                    FrmObj = Nothing
                End If
            ...
            Try
                ...
                If AgLibrary.ClsConstant.IsSmsActive Then
                    Call ProcCreateSms(Scholar_Main.ClsMain.SmsEvent.BirthDay_Student)
                    Call ProcCreateSms(Scholar_Main.ClsMain.SmsEvent.BirthDay_Employee)
                    Call ProcCreateSms(Scholar_Main.ClsMain.SmsEvent.MarriageAnniversary_Employee)
                    Call ProcCreateSmsBookReturnReminder(Academic_Library.ClsMain.SmsEvent.BookReturn_Reminder)
        ...
        Catch ex As Exception
            MsgBox(ex.Message & vbCrLf & "Can't Load Software!...")
            End
        Finally
            If bDtTemp IsNot Nothing Then bDtTemp.Dispose()
            Me.Cursor = Cursors.Default
    ...
    TSSL_SendSMS.Click
        ...
        Try
            Me.Cursor = Cursors.WaitCursor
            Dim CFOpen_ScholarMain As New Scholar_Main.ClsFunction
            Dim MDI_ScholarMain As New Scholar_Main.MDIMain

            Select Case sender.Name
                Case TSSL_Student.Name
                    StrUserPermission = AgIniVar.FunGetUserPermission(Scholar_Fee.ClsMain.ModuleName, MDI_ScholarMain.MnuAmStudentMaster.Name, MDI_ScholarMain.MnuAmStudentMaster.Text, DTUP)
                    StrUserPermission = "****"

                    FrmObj = CFOpen_ScholarMain.FOpen(MDI_ScholarMain.MnuAmStudentMaster.Name, MDI_ScholarMain.MnuAmStudentMaster.Text)
                ...
                Case TSSL_Btn_UpdateTableStructure.Name
                    ...
                    Cls_Scholar_Fee.UpdateTableStructure(AgL.PubMdlTable)
                    Cls_Scholar_Enquiry.UpdateTableStructure(AgL.PubMdlTable)
                    Cls_Scholar_TimeTable.UpdateTableStructure(AgL.PubMdlTable)
                    Cls_Scholar_SmsEMail.UpdateTableStructure(AgL.PubMdlTable)
                    Cls_Academic_Mess.UpdateTableStructure(AgL.PubMdlTable)
                    Cls_Academic_Canteen.UpdateTableStructure(AgL.PubMdlTable)
                    Cls_Academic_Store.UpdateTableStructure(AgL.PubMdlTable)
                    Cls_Academic_Transport.UpdateTableStructure(AgL.PubMdlTable)
                    ...
                    Cls_Academic_Transport.UpdateTableInitialiser()
                    Cls_Academic_Mess.UpdateTableInitialiser()
                    Cls_Academic_Canteen.UpdateTableInitialiser()

                    Cls_Scholar_Common.UpdateTableStructure()
                    Cls_Scholar_Main.UpdateTableStructure()
                    Cls_Scholar_Fee.UpdateTableStructure()
                    Cls_Scholar_TimeTable.UpdateTableStructure()
                    Cls_Academic_Exam.UpdateTableStructure()
                    Cls_Academic_Store.UpdateTableStructure()
                    Cls_Scholar_Hostel.UpdateTableStructure()
                    Cls_Scholar_Enquiry.UpdateTableStructure()


                    Cls_SMS.UpdateTableStructure()
                    Cls_EMail.UpdateTableStructure()
                    Cls_Scholar_SmsEMail.UpdateTableInitialiser()
...
#End Region
    ...
    Private Sub ProcCreateSms(ByVal StrEvent As String)
        ...
        Try
            ...
            If AgL.StrCmp(StrEvent, Scholar_Main.ClsMain.SmsEvent.BirthDay_Student) Then
                bStrMainTable = "Sch_Student"
                bStrMainField = "Sg.DOB"

            ElseIf AgL.StrCmp(StrEvent, Scholar_Main.ClsMain.SmsEvent.BirthDay_Employee) Then
                bStrMainTable = "Pay_Employee"
                bStrMainField = "Sg.DOB"

            ElseIf AgL.StrCmp(StrEvent, Scholar_Main.ClsMain.SmsEvent.MarriageAnniversary_Employee) Then
                bStrMainTable = "Pay_Employee"
                bStrMainField = "Sg.MarriageDate"
            End If
