...
Module MdlFunction
    Public Function FOpenIni(ByVal StrIniPath As String, ByVal StrUserName As String, ByVal StrPassword As String) As Boolean
        ...
        Try
            ...
            AgL.PubReportPath = AgL.INIRead(StrIniPath, "Reports", "Path", Vidya.My.Application.Info.DirectoryPath + "\Reports")
...
#End Region
    ...
    Public Sub ProcUpdateInActiveMenu()
        ...
        Dim MDI_Scholar_Exam As New Scholar_Exam.MDIMain
        Dim MDI_Academic_Hostel As New Academic_Hostel.MDIMain
        ...
        Try
            ...
            '=========================================================================================================================
            bInActiveMenuList = "" & AgL.Chk_Text(MDI_Scholar_Exam.MnuUtility.Name) & ""

            bInActiveMenuList += ", " & AgL.Chk_Text(MDI_Scholar_Exam.MnuEnvironmentSettings.Name) & ""

            If bInActiveMenuList.Trim <> "" Then Call ProcExecuteUpdateInActiveMenuQuery(Scholar_Exam.ClsMain.ModuleName, bInActiveMenuList) : bInActiveMenuList = ""
            '=========================================================================================================================
            ...
            If bIsRoomCharges = False Then
                ...
                bInActiveMenuList = "" & AgL.Chk_Text(MDI_Academic_Hostel.MnuChargeGroupMaster.Name) & ""

                bInActiveMenuList += ", " & AgL.Chk_Text(MDI_Academic_Hostel.MnuChargeMaster.Name) & ""

                bInActiveMenuList += ", " & AgL.Chk_Text(MDI_Academic_Hostel.MnuAdvanceReceiveEntry.Name) & ""

                bInActiveMenuList += ", " & AgL.Chk_Text(MDI_Academic_Hostel.MnuRoomChargeDueEntry.Name) & ""

                bInActiveMenuList += ", " & AgL.Chk_Text(MDI_Academic_Hostel.MnuRoomChargeReceive.Name) & ""

                bInActiveMenuList += ", " & AgL.Chk_Text(MDI_Academic_Hostel.MnuRoomCbargeRefundEntry.Name) & ""

                bInActiveMenuList += ", " & AgL.Chk_Text(MDI_Academic_Hostel.MnuAdvanceChargeRegister.Name) & ""

                bInActiveMenuList += ", " & AgL.Chk_Text(MDI_Academic_Hostel.MnuChargeDueRegister.Name) & ""

                bInActiveMenuList += ", " & AgL.Chk_Text(MDI_Academic_Hostel.MnuChargeReceiveRegister.Name) & ""

                bInActiveMenuList += ", " & AgL.Chk_Text(MDI_Academic_Hostel.MnuChargeRefundRegister.Name) & ""

                bInActiveMenuList += ", " & AgL.Chk_Text(MDI_Academic_Hostel.MnuMemberWiseOutstandingSummary.Name) & ""

                If bInActiveMenuList.Trim <> "" Then Call ProcExecuteUpdateInActiveMenuQuery(Academic_Hostel.ClsMain.ModuleName, bInActiveMenuList) : bInActiveMenuList = ""
