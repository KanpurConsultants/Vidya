...
#Region "Form Designer Code"
    ...
    Public WithEvents BtnCancelled As System.Windows.Forms.Button
    Protected WithEvents LblVerify As System.Windows.Forms.LinkLabel
    ...
    Public Sub InitializeComponent()
        ...
        Me.LblVerify = New System.Windows.Forms.LinkLabel
        ...
        'TP1
        '
        Me.TP1.Controls.Add(Me.LblVerify)
        ...
        Me.TP1.Controls.SetChildIndex(Me.LblVerify, 0)
        '
        'Topctrl1
        '
        ...
        'GBoxApproved
        '
        Me.GBoxApproved.Controls.Add(Me.BtnCancelled)
        Me.GBoxApproved.Location = New System.Drawing.Point(770, 313)
        Me.GBoxApproved.Size = New System.Drawing.Size(215, 51)
        Me.GBoxApproved.Text = "Approved/Cancelled By "
        Me.GBoxApproved.Controls.SetChildIndex(Me.TxtApproved, 0)
        Me.GBoxApproved.Controls.SetChildIndex(Me.BtnApproved, 0)
        Me.GBoxApproved.Controls.SetChildIndex(Me.BtnCancelled, 0)
        '
        'GrpUP
        '
        ...
        Me.BtnCancelled.Font = New System.Drawing.Font("Arial", 10.25!)
        Me.BtnCancelled.Image = Global.Scholar_TimeTable.My.Resources.Resources.Cancel
        Me.BtnCancelled.Location = New System.Drawing.Point(184, 20)
        Me.BtnCancelled.Name = "BtnCancelled"
        Me.BtnCancelled.Size = New System.Drawing.Size(23, 23)
        Me.BtnCancelled.TabIndex = 37
        Me.BtnCancelled.UseVisualStyleBackColor = True
        '
        'LblVerify
        '
        Me.LblVerify.BackColor = System.Drawing.Color.SteelBlue
        Me.LblVerify.DisabledLinkColor = System.Drawing.Color.White
        Me.LblVerify.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.LblVerify.LinkBehavior = System.Windows.Forms.LinkBehavior.NeverUnderline
        Me.LblVerify.LinkColor = System.Drawing.Color.White
        Me.LblVerify.Location = New System.Drawing.Point(716, 10)
        Me.LblVerify.Name = "LblVerify"
        Me.LblVerify.Size = New System.Drawing.Size(110, 20)
        Me.LblVerify.TabIndex = 1007
        Me.LblVerify.TabStop = True
        Me.LblVerify.Text = "Approved"
...
#End Region
    ...
    Public Sub Form_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        ...
        If BlnIsApprovalApply Then
            If FormType = eFormType.Main Then
                mCondStr += " And H.ApprovedDate Is Null And H.CancelledDate Is Null "
            ElseIf FormType = eFormType.Approved Then
                mCondStr += " And (H.ApprovedDate Is Not Null Or H.CancelledDate Is Not Null) "
            End If
        End If
    ...
    Public Sub Form_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                If AgL.XNull(.Rows(0)("CancelledDate")).ToString.Trim <> "" Then
                    LblVerify.Text = VerifyStatus.Cancelled
                    TxtApproved.Text = AgL.XNull(.Rows(0)("CancelledBy"))
                Else
                    If AgL.XNull(.Rows(0)("ApprovedDate")).ToString.Trim <> "" Then
                        LblVerify.Text = VerifyStatus.Approved
                        TxtApproved.Text = AgL.XNull(.Rows(0)("ApprovedBy"))
                    Else
                        LblVerify.Text = ""
                    End If
                End If
                LblVerify.Visible = IIf(LblVerify.Text.Trim <> "", True, False)
    ...
    Public Sub Form_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        TxtSubCode.AgHelpDataSet(6, Tc1.Top + TP1.Top, Tc1.Left + TP1.Left) = HelpDataSet.SubCode.Copy
    End Sub
    ...
    Public Sub Txt_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles _
        ...
        TxtToDate.Validating, TxtSubCode.Validating, TxtTotalDays.Validating
    ...
    Public Sub Form_BaseEvent_Approve_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Approve_InTrans
        ...
        '-------------------------------------------------------------------------        
        mQry = "Update Pay_Leave " & _
                " Set " & _
                " CancelledBy = Null, " & _
                " CancelledDate = Null " & _
    ...
    Private Sub BtnCancelled_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelled.Click
        ...
        Select Case sender.name
            Case BtnCancelled.Name
                Try
                    If Topctrl1.Mode = "Browse" Then
                        If MsgBox("Are You Sure To Cancel Record", MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, "Cancelled Confirmation...") = MsgBoxResult.No Then Exit Sub
                    End If

                    If AgL.StrCmp(LblVerify.Text, VerifyStatus.Cancelled) Then
                        MsgBox("Record is already Cancelled!...", MsgBoxStyle.Information)
                        Err.Raise(1, , "")
                    End If
                    ...
                    If mSearchCode <> "" Then
                        ...
                        mCancelledDate = AgL.GetDateTime(AgL.GcnRead)
                        ...
                        Call ProcCancelVoucher(TxtApproved.Text, mCancelledDate)

                        ''===========================================================================

                        AgL.SynchroniseSiteOnLineData(AglObj, AgL.GCn, AgL.Gcn_ConnectionString, AgL.GcnSite_ConnectionString, AgL.ECmd)
                        AgL.ETrans.Commit()
                        mTrans = False


                        MsgBox("Voucher Cancelled Successfully.", MsgBoxStyle.Information, AgLibrary.ClsMain.PubMsgTitleInfo)
                        If AgL.PubMoveRecApplicable Then
                            Form_BaseFunction_FIniMast(0, 1) : Form_BaseFunction_FIniList()
                        End If
                        MoveRec()
                    End If
    ...
    Private Sub ProcCancelVoucher(ByVal StrApprovedBy As String, ByVal StrCancelledDate As String)
        mQry = "Update Pay_Leave " & _
                " Set " & _
                " ApprovedBy=Null, " & _
                " ApprovedDate=Null, " & _
                " CancelledBy='" & StrApprovedBy & "', " & _
                " CancelledDate=" & AgL.Chk_Text(StrCancelledDate) & " " & _
                " Where DocId='" & mSearchCode & "' "
        AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)

        Call AgL.LogTableEntry(mSearchCode, Me.Text, AgLibrary.ClsConstant.EntryMode_Varified, AgL.PubMachineName, AgL.PubUserName, AgL.PubLoginDate, AgL.GCn, AgL.ECmd, , TxtV_Date.Text, , , , TxtSite_Code.AgSelectedValue, TxtDivision.AgSelectedValue)
    End Sub
End Class
