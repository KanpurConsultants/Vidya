...
Public Class FrmSaleInvoiceOld
...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        'Label2
        '
        Me.Label2.Location = New System.Drawing.Point(111, 39)
        Me.Label2.Tag = ""
        '
        'LblV_Date
        '
        ...
        'LblV_TypeReq
        '
        Me.LblV_TypeReq.Location = New System.Drawing.Point(323, 19)
        Me.LblV_TypeReq.Tag = ""
        '
        'TxtV_Date
        '
        ...
        Me.TxtV_Type.Location = New System.Drawing.Point(341, 13)
        ...
        'LblSite_CodeReq
        '
        Me.LblSite_CodeReq.Location = New System.Drawing.Point(111, 19)
        ...
        Me.TabControl1.Size = New System.Drawing.Size(992, 113)
        ...
        Me.TP1.Size = New System.Drawing.Size(984, 87)
        ...
        Me.Label4.Location = New System.Drawing.Point(111, 60)
        ...
        Me.TxtSaleToParty.Location = New System.Drawing.Point(127, 53)
        ...
        Me.LblBuyer.Location = New System.Drawing.Point(7, 53)
        ...
        Me.TxtSalesTaxGroupParty.Location = New System.Drawing.Point(792, 11)
        ...
        Me.Label27.Location = New System.Drawing.Point(686, 13)
        ...
        Me.TxtRemarks.Location = New System.Drawing.Point(598, 51)
        ...
        Me.Label30.Location = New System.Drawing.Point(510, 53)
        ...
        Me.TxtReferenceNo.Location = New System.Drawing.Point(341, 33)
        ...
        Me.LblReferenceNo.Location = New System.Drawing.Point(233, 33)
        ...
        Me.LblCurrency.Location = New System.Drawing.Point(510, 13)
        ...
        Me.TxtCurrency.Location = New System.Drawing.Point(598, 12)
        ...
        'BtnFillSaleChallan
        '
        Me.BtnFillSaleChallan.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.BtnFillSaleChallan.Location = New System.Drawing.Point(530, 133)
        Me.BtnFillSaleChallan.Margin = New System.Windows.Forms.Padding(0)
        Me.BtnFillSaleChallan.Name = "BtnFillSaleChallan"
        Me.BtnFillSaleChallan.Size = New System.Drawing.Size(26, 25)
        ...
        Me.TxtCreditDays.Location = New System.Drawing.Point(942, 31)
        ...
        Me.LblCreditDays.Location = New System.Drawing.Point(863, 32)
        ...
        Me.TxtCreditLimit.Location = New System.Drawing.Point(792, 31)
        ...
        Me.LblCreditLimit.Location = New System.Drawing.Point(686, 32)
        ...
        Me.TxtCurrBal.Location = New System.Drawing.Point(598, 32)
        ...
        Me.Label3.Location = New System.Drawing.Point(510, 33)
        ...
        Me.BtnFillPartyDetail.Location = New System.Drawing.Point(478, 51)
...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = " Update SaleInvoice " & _
                ...
                " InvoiceType = " & AgL.Chk_Text(bInvoiceType) & ", " & _
        ...
        mQry = "Insert Into SaleInvoiceDetail(DocId, Sr, SaleChallan, SaleChallanSr, SaleOrder, SaleOrderSr, Item_Uid, Item, SalesTaxGroupItem, " & _
                ...
                " TotalMeasure, Rate, Amount, Remark, BillingType, BaleNo, DeliveryMeasure, DeliveryMeasureMultiplier, TotalDeliveryMeasure, " & AgCalcGrid1.FLineTableFieldNameStr() & ") "
        ...
        Call ClsMain.PostStructureToAccounts(AgCalcGrid1, TxtRemarks.Text, mSearchCode, TxtDivision.AgSelectedValue, TxtSite_Code.AgSelectedValue, TxtDivision.AgSelectedValue, _
                                             TxtV_Type.AgSelectedValue, LblPrefix.Text, TxtV_No.Text, TxtReferenceNo.Text, TxtSaleToParty.AgSelectedValue, TxtV_Date.Text, Conn, Cmd)
    ...
    Private Sub FrmSaleOrder_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = "Select H.*, Sg.DispName + ',' + IsNull(C1.CityName,'') As BuyerName, C.Description As CurrencyDesc, C1.CityName As SaleToPartyCityName " & _
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                TxtSaleToParty.Text = AgL.XNull(.Rows(0)("BuyerName"))
                ...
                If AgL.XNull(.Rows(0)("InvoiceType")) = InvoiceType_ForChallan Then
                    RbtInvoiceForChallan.Checked = True
                ElseIf AgL.XNull(.Rows(0)("InvoiceType")) = InvoiceType_ForOrder Then
                ...
                Dim FrmObj As New FrmSaleInvoicePartyDetailOld
    ...
    Private Sub TxtBuyer_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtSaleToParty.KeyDown, TxtCurrency.KeyDown, TxtSalesTaxGroupParty.KeyDown
        Try
            ...
            Select Case sender.name
                ...
                Case TxtSaleToParty.Name
                    If TxtSaleToParty.AgHelpDataSet Is Nothing Then
                        mQry = "SELECT Sg.SubCode As Code, Sg.DispName + ',' + IsNull(C.CityName,'') As Party, Sg.SalesTaxPostingGroup, " & _
    ...
    Private Sub FOpenPartyDetail()
        Dim FrmObj As FrmSaleInvoicePartyDetailOld
        Try
            If BtnFillPartyDetail.Tag Is Nothing Then
                FrmObj = New FrmSaleInvoicePartyDetailOld
            Else
    ...
    Public Sub FSetParameter(ByVal IsMeasurePerPcsEditable As Boolean, ByVal IsMeasureUnitEditable As Boolean, _
                             ...
                             ByVal IsCheckQcQty As Boolean, ByVal IsDirectInvoice As Boolean)
