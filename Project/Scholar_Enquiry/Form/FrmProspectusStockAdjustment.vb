...
Public Class FrmProspectusStockAdjustment
    ...
    Public Sub New(ByVal StrUserPermission, ByVal DTUP)
        ...
        Me.EntryNCatList = "" & AgL.Chk_Text(ClsMain.Temp_NCat.ProspectusAdjustment) & ""
    End Sub
...
#End Region
    ...
    Public Sub Form_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        With AgCL
            ...
            .AddAgTextColumn(DGL1, Col1ProcpectusNo, 100, 50, Col1ProcpectusNo, True, False, False)
        ...
        For bIntI = 0 To DGL1.RowCount - 1
            If DGL1.Item(Col1Item, bIntI).Value.ToString.Trim <> "" _
                ...
                mQry = "INSERT INTO dbo.Store_Stock (DocId, Sr, UID, Div_Code, Site_Code, V_Type, V_Prefix, V_No, V_Date, " & _
                                ...
                                " Rate, Amount, Remark,Session,Programme,ProspectusNo,Semester) " & _
                                " VALUES (" & _
    ...
    Private Sub TempGr_BaseFunction_CreateHelpDataSet() Handles Me.BaseFunction_CreateHelpDataSet
        ...
        Try
            ...
            mQry = "SELECT Distinct P.ProspectusNo AS Code, P.ProspectusNo AS ProspectusNo,P.Item as ItemCode" & _
...
" ORDER BY VS.Description "
    ...
    Public Sub Form_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        ...
        DGL1.AgHelpDataSet(Col1ProcpectusNo, 1) = HelpDataSet.ProcpectusNo.Copy
        ...
        Try
            ...
            Select Case DGL1.Columns(DGL1.CurrentCell.ColumnIndex).Name
                ...
                Case Col1ProcpectusNo
                    DGL1.AgRowFilter(mColumnIndex) = " ItemCode = " & AgL.Chk_Text(DGL1.AgSelectedValue(Col1Item, mRowIndex)) & " "
