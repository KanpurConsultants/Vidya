...
Module MdlFunction
    ...
    End Sub
    Public Sub IniDtEnquiry_Enviro()
        If AgL.IsTableExist("Enquiry_Enviro", AgL.GCn) Then
            DtEnquiry_Enviro = AgL.FillData("SELECT E.* FROM Enquiry_Enviro E WHERE E.Site_Code ='" & AgL.PubSiteCode & "'", AgL.GCn).Tables(0)
        End If
    End Sub
End Module