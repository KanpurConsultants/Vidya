...
Public Class FrmEnviro
    ...
    Sub Ini_List()
        Try
            ...
            TxtSalesTaxGroupItem.AgHelpDataSet(1, TcEnviro.Top + TpAcParameter.Top, TcEnviro.Left + TpAcParameter.Left) = AgL.FillData(mQry, AgL.GcnRead)
            ...
            mQry = "SELECT P.Description AS Code, P.Description AS Name, " & _
                    ...
                    " Order By P.Description "
            TxtSalesTaxGroupParty.AgHelpDataSet(1, TcEnviro.Top + TpAcParameter.Top, TcEnviro.Left + TpAcParameter.Left) = AgL.FillData(mQry, AgL.GcnRead)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
        ...
        Try
            ...
            If DTMaster.Rows.Count > 0 Then
                If MsgBox("Are You Sure To Delete This Record?", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, AgLibrary.ClsMain.PubMsgTitleInfo) = vbYes Then
                    ...
                    AgL.Dman_ExecuteNonQry("Delete From Enquiry_Enviro Where Site_Code='" & mSearchCode & "'", AgL.GCn, AgL.ECmd)
    ...
    Private Sub Topctrl1_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            ...
            AgL.PubFindQry = " Select  E.Site_Code As SearchCode,  S.Name As [" & LblSite_Code.Text & "] " & _
                                " From Enquiry_Enviro E " & _
                                " Left Join SiteMast S On E.Site_Code = S.Code "


            AgL.PubFindQryOrdBy = "[" & LblSite_Code.Text & "]"
    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                mQry = " INSERT INTO Enquiry_Enviro	" & _
                        " (Site_Code, SalesTaxGroupItem, SalesTaxGroupParty, " & _
                        " Div_Code, PreparedBy,U_EntDt, U_AE	) " & _
                        " VALUES (" & AgL.Chk_Text(TxtSite_Code.AgSelectedValue) & ", " & AgL.Chk_Text(TxtSalesTaxGroupItem.AgSelectedValue) & ", " & _
    ...
    Private Sub Control_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles _
        TxtSalesTaxGroupParty.Enter, TxtSalesTaxGroupItem.Enter

        Try
            Select Case sender.name
                Case TxtSalesTaxGroupParty.Name, TxtSalesTaxGroupItem.Name
